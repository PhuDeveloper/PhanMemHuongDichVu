...
<body>
	...
	<div class="main-w3layouts wrapper" style="padding-top: 100px;">
		<h1>Đăng kí</h1>
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input class="text" type="text" name="HoTen" placeholder="Họ tên"
						required=""> <input style="margin-top: 25px;" class="text"
						type="text" name="TaiKhoan" placeholder="Tài khoản" required=""><input
						class="text email" type="text" name="SDT"
						placeholder="Số điện thoại" required=""> <input
						class="text" type="password" name="Matkhau" placeholder="Mật khẩu"
						required=""> <input class="text w3lpass" type="password"
						name="MatKhau" placeholder="Nhập lại mật khẩu" required="">
					<input type="submit" value="Đăng kí">
				</form>
				<p>
					Đăng nhập ngay tại đây? <a href="DangNhap">Đăng nhập!</a>
				</p>
			</div>
		</div>
		<!-- copyright -->
